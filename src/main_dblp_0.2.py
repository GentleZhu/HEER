...
import cPickle
args = {'emb_size':128, 'window_size':1, 'batch_size':128, 'iter':40, 'neg_ratio':5, 'graph_name':'dblp_0.2_',
       'pre_train_path':'/shared/data/yushi2/edge_rep_codes/intermediate_data/dblp_0.2_out_line_samples200000_alpha0.1_dim128.emb',
       'node_types':['A','P','Y','W','V'], 'edge_types':[(1,0),(1,1),(1,2),(1,3),(1,4)], 'gpu':5, 'lr':2.5, 'mode': 1}
print(args)
...
model = SkipGram({'emb_size':args['emb_size'],
                  ...
                  'pre_train':_data, 'node_types':args['node_types'], 'lr_ratio':2,
