...
if __name__ == '__main__':
    ...
    with open(input_scorefile, "r") as f_in:
        ...
        assert idx+1/(2*negative_sample_number+1) == num_positive_edges, str(idx)+" "+str(num_positive_edges)
        ...
        for idx, line in enumerate(f_in):
            ...
            if count==0: 
                ...
                if count==(sample_number*2):  
                    ...
                    count+=1
        assert idx+1/(2*negative_sample_number+1) == num_positive_edges, "Number of positive edges does not agree."
